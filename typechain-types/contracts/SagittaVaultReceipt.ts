...
export interface SagittaVaultReceiptInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface SagittaVaultReceipt extends BaseContract {
  connect(runner?: ContractRunner | null): SagittaVaultReceipt;
  waitForDeployment(): Promise<this>;

  interface: SagittaVaultReceiptInterface;
