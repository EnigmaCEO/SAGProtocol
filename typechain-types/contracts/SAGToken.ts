...
export interface SAGTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface SAGToken extends BaseContract {
  connect(runner?: ContractRunner | null): SAGToken;
  waitForDeployment(): Promise<this>;

  interface: SAGTokenInterface;
